...
namespace PersonelFollow.WebUI.Models
{
    public class UserProfileEditModel
    {
        ...
        [Display(Name = "Eski Şifre Tekrar")]
        [Required(ErrorMessage = "Eski Şifre Tekrar alanı boş geçilemez.")]
        [MinLength(8, ErrorMessage = "Eski Şifre Tekrar alanı en az {1} karakter olabilir."), MaxLength(30, ErrorMessage = "Eski Şifre Tekrar alanı en fazla {1} karakter olabilir.")]
